...
go test -run 'TestValidateMTU|TestFdTUNCloseEvents|TestPluginJSON|TestStatusBlock|TestConfigMerge|TestProcessStarttime|TestDaemonPIDRoundTrip|TestExitNodePrefs' -v ./...
